...
function App() {
  ...
  return (
    <>
      <Modal open={errorUpdatingPlaces} onclose={handleRemovePlace}>
        {errorUpdatingPlaces && (<ErrorPage title="An error occurred. Please try again later" message={errorUpdatingPlaces.message}
